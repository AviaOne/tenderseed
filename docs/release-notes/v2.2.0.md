...
- The close error of the configuration file is explicitly discarded rather than
  left implicit, which is the right call for a file opened to read. An earlier
  wording of this line claimed it was checked; it is not.
